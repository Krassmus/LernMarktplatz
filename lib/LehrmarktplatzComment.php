            ...
            if (!$this['host_id']) {
                ...
                foreach ($hosts as $host_id) {
                    ...
                    if (!$remote->isMe()) {
                        ...
                        $host_hash = md5($this->review['foreign_review_id'] ? $this->review->host['public_key'] : $myHost['public_key']);
                        var_dump($this->review['foreign_review_id'] ? $this->review->host['public_key'] : $myHost['public_key']);
                        var_dump($host_hash);
